...
func (s *BrandService) GetAllBrands(page, pageSize int, search string) ([]models.Brand, int64, error) {
	return s.repo.FindAll(page, pageSize, search)
}

func (s *BrandService) UpdateBrand(id uint, updatedBrand *models.Brand) error {
